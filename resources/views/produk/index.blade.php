        ...
        table = $('.table').DataTable({
            ...
            columns: [
                ...
                {data: 'stok', render: function(data, type, row) {
                    // Menampilkan ikon peringatan jika stok kurang dari 100
                    let warningIcon = data < 100 ? '<i class="fa fa-exclamation-triangle text-warning"></i>' : '';
                    return data + ' ' + warningIcon; // Tambahkan ikon peringatan setelah jumlah stok
                }},
                {data: 'satuan'},
